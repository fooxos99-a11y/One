...
export default function AdminStudentExamsPage() {
  ...
  useEffect(() => {
    async function bootstrap() {
      ...
      try {
        const [circlesResponse, settingsResponse, portionSettingsResponse] = await Promise.all([
        ...
        if (!circlesResponse.ok || !settingsResponse.ok || !portionSettingsResponse.ok) {
  ...
  }, [authLoading, authVerified, examDialogCircle])
