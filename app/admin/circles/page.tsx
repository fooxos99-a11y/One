...
export default function CircleManagement() {
  return <CircleManagementContent displayMode="page" />
}

export function CircleManagementContent({
  displayMode = "page",
  onInlineActionsChange,
}: {
  displayMode?: "page" | "inline"
  onInlineActionsChange?: (actions: { openAddDialog: () => void }) => void
}) {
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              {displayMode === "inline" ? null : (
                <DialogTrigger asChild>
                  <button className="inline-flex h-12 items-center gap-2 rounded-full border border-[#d8e5fb] bg-white px-5 text-sm font-bold text-[#3453a7] shadow-[0_10px_30px_rgba(52,83,167,0.08)] transition-all hover:bg-[#f6f9ff]">
