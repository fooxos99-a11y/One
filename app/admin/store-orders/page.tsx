...
import { ShoppingBag, Package, Check, Trash2 } from "lucide-react";
import { useAdminAuth } from "@/hooks/use-admin-auth"

export default function StoreOrdersPage() {
  return <StoreOrdersContent displayMode="page" />
}

export function StoreOrdersContent({
  displayMode = "page",
  onBack,
}: {
  ...
  return (
    <div dir="rtl" className={`${displayMode === "inline" ? "bg-transparent" : "min-h-screen bg-[#fafaf9]"} flex flex-col`}>
      {displayMode === "inline" ? null : <Header />}

      <main className={`flex-1 ${displayMode === "inline" ? "px-0 py-0" : "py-10 px-4"}`}>
        {content}
      </main>
