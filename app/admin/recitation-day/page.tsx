...
export function RecitationDayContent({
  displayMode = "page",
        ...
        <Card className="rounded-[30px] border-[#dde6f0] bg-white shadow-[0_16px_45px_rgba(15,23,42,0.06)]">
          <CardHeader className="text-right">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <CardTitle className="text-2xl font-black text-[#1a2332]"><span>يوم السرد</span></CardTitle>
              {displayMode !== "inline" ? (
              <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
                <Button type="button" onClick={() => setIsTemplatesDialogOpen(true)} className="inline-flex h-12 items-center rounded-full border border-[#d8e5fb] bg-white px-5 text-sm font-bold text-[#3453a7] shadow-[0_10px_30px_rgba(52,83,167,0.08)] transition-all hover:bg-[#f6f9ff] sm:w-auto">
                  القوالب
                </Button>
                <Link href="/admin/recitation-day/archive" className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-[#3453a7] px-5 text-sm font-bold text-white shadow-[0_10px_30px_rgba(52,83,167,0.16)] transition-all hover:bg-[#24428f]">
...
export default function AdminRecitationDayPage() {
  return <RecitationDayContent displayMode="page" />
}