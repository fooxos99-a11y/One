          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-[#f8fbff] border-b border-[#e2eaf7] hover:bg-[#f8fbff]">
                ...
                <TableHead className="text-center text-[#20335f] font-extrabold text-base">الملاحظات</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {isFuture ? (
                <TableRow>
                  <TableCell colSpan={8} className="text-center py-12 text-[#7b8aa0]">
                ...
                group.records.map((record, recordIndex) => (
                  <TableRow key={record.id} className="transition-colors duration-150 hover:bg-white border-b border-[#eef3fb]">
                    ...
                    <TableCell className="text-center text-base max-w-[200px]">
                      {record.notes ? <span className="text-neutral-600">{record.notes}</span> : <span className="text-gray-300">—</span>}
                    </TableCell>
                  </TableRow>
                ))
              )) : (
