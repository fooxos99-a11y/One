...
export default function QuestionsDatabase() {
  return <QuestionsDatabaseContent displayMode="page" />
}

export function QuestionsDatabaseContent({ displayMode = "page" }: { displayMode?: "page" | "inline" }) {
  ...
  return (
    <div dir="rtl" className={`${displayMode === "inline" ? "bg-transparent" : "min-h-screen bg-[#f8fbff]"} flex flex-col`}>
      ...
      <main className={`flex-1 ${displayMode === "inline" ? "px-0 py-0" : "px-4 py-8 sm:px-6 lg:px-8"}`}>
