...
import { BarChart3, CircleHelp, Edit, Plus, Trash2 } from "lucide-react"
...
export default function MillionaireQuestionsAdminPage() {
  return <MillionaireQuestionsAdminContent displayMode="page" />
}

export function MillionaireQuestionsAdminContent({ displayMode = "page" }: { displayMode?: "page" | "inline" }) {
  ...
  return (
    <div dir="rtl" className={`${displayMode === "inline" ? "bg-transparent" : "min-h-screen bg-[#f8fbff]"} flex flex-col`}>
      ...
      <main className={`flex-1 ${displayMode === "inline" ? "px-0 py-0" : "px-4 py-8 lg:px-6"}`}>
        <div className="mx-auto max-w-7xl space-y-8">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-5 shadow-sm space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Button variant={selectedDifficulty === "medium" ? "default" : "outline"} className={selectedDifficulty === "medium" ? "bg-[#4f73d1] hover:bg-[#3453a7]" : ""} onClick={() => setSelectedDifficulty("medium")}>متوسط</Button>
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                        <div className="space-y-4 flex-1">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <span className="inline-flex rounded-full bg-[#3453a7]/10 px-3 py-1 text-sm font-semibold text-[#3453a7]">
